        ...
        {users.filter(u=>u.active).map((u,i) => {
          ...
          return (
            <button key={u.id} onClick={()=>onSelect(u)}
              style={{width:"100%", display:"flex", alignItems:"center", gap:14, padding:"16px 16px", marginBottom:8, background:T.white, borderRadius:16, border:`1px solid ${T.grey200}`, cursor:"pointer", fontFamily:font, boxShadow:CS, animation:`fadeUp ${150+i*50}ms both`}}>
