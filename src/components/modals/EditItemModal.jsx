...
export function EditItemModal({item, setItems, onClose, showToast}) {
  ...
  return (
    <div style={{padding:"16px 20px 0"}}>
      ...
      <p style={{margin:"0 0 6px",fontSize:14,fontWeight:600,color:T.grey700}}>품목명</p><Inp value={name} onChange={e=>setName(e.target.value)} style={{marginBottom:12}}/>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:12}}>
        <div><p style={{margin:"0 0 6px",fontSize:14,fontWeight:600,color:T.grey700}}>단위</p><Inp value={unit} onChange={e=>setUnit(e.target.value)}/></div>
      ...
      <p style={{margin:"0 0 6px",fontSize:14,fontWeight:600,color:T.grey700}}>보관 위치</p><Inp value={loc} onChange={e=>setLoc(e.target.value)} style={{marginBottom:16}}/>
