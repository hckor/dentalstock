  ...
  return (
    <div style={{padding:"16px 20px 0"}}>
      <div style={{display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:16}}>
        <h2 style={{margin:0, fontSize: 24, fontWeight:700, color:modal==="in"?T.blue500:T.red500}}>{modal==="in"?"입고 등록":"출고 등록"}</h2>
      ...
      <div style={{background:T.grey50, borderRadius:12, padding:"16px 18px", marginBottom:20, border:`1.5px solid ${modal==="in"?T.blue500+"33":T.red500+"33"}`}}>
        ...
        <p style={{margin:"4px 0 0", fontSize: 16, color:T.grey600}}>현재 재고 <span style={{fontWeight:700, color:modal==="in"?T.blue500:T.red500}}>{selItem.current_qty}{selItem.unit}</span></p>
      </div>
