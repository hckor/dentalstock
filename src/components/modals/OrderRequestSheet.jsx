  ...
  return (
    <div style={{padding:"16px 20px 0"}}>
      <div style={{display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:16}}>
        <h2 style={{margin:0, fontSize:26, fontWeight:700, color:T.grey900}}>발주 요청</h2>
      ...
      <div style={{background:T.teal50, borderRadius:12, padding:"16px 18px", marginBottom:20, border:`1px solid ${T.teal500}22`}}>
        ...
        <p style={{margin:0, fontSize:19, color:T.grey600}}>
      ...
      <p style={{margin:"0 0 8px", fontSize:19, fontWeight:600, color:T.grey700}}>요청 수량</p>
      ...
      <p style={{margin:"0 0 8px", fontSize:19, fontWeight:600, color:T.grey700}}>메모 <span style={{fontWeight:400, color:T.grey400}}>(선택)</span></p>
      ...
      <div style={{display:"flex", alignItems:"center", gap:8, padding:"14px 18px", background:T.grey50, borderRadius:12, marginBottom:20, border:`1px solid ${T.grey200}`}}>
        ...
        <p style={{margin:0, fontSize:19, color:T.grey600}}><span style={{fontWeight:600, color:T.grey900}}>{currentUser.name}</span> · 장바구니 확인 후 일괄 발주 요청</p>
      </div>
      <button onClick={()=>onSubmit(item,qty,note)} style={{width:"100%", padding:"16px 0", borderRadius:9999, border:"none", cursor:"pointer", fontFamily:font, fontSize:19, fontWeight:600, color:T.white, background:T.blue500}}>
        장바구니에 담기
      </button>
    </div>
  );
